...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LastChange) DeepCopyInto(out *LastChange) {
	*out = *in
	out.TargetRef = in.TargetRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LastChange.
func (in *LastChange) DeepCopy() *LastChange {
	if in == nil {
		return nil
	}
	out := new(LastChange)
...
func (in *LendingConfigStatus) DeepCopyInto(out *LendingConfigStatus) {
	*out = *in
	if in.LastChanges != nil {
		in, out := &in.LastChanges, &out.LastChanges
		*out = make([]LastChange, len(*in))
		copy(*out, *in)
	}
}
